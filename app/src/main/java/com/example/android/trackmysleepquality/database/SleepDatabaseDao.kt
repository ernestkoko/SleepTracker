...
@Dao // this tells the DB to use this as the Data Access Object(DAO)
interface SleepDatabaseDao{

    @Insert  //this tells Room to insert into the DB
    fun insert(night: SleepNight) // the funtion inserts SleepNight table
