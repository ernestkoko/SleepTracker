...
class SleepTrackerViewModel(
    ...
    //formatting to strings. it executes every time night changes
    ...
    private suspend fun getTonightFromDatabase(): SleepNight? { // the suspend keyword ensures the function does not block
